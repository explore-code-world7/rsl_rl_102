...
class ReplayBuffer:
    ...
    # adopts circular queue, FIFO, build obs and next_obs list for later sampling.
    ...
    def feed_forward_generator(
        ...
        * silently sample **with replacement** when `allow_replacement=True`
        ...
        # overall, sample from buffer data with size of `total = num_mini_batch * mini_batch_size``
